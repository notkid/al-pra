...
function choujiang(code, validcode) {
    let api1 = "https://web.kwwblcj.com/api.php?m=weixin-send&do=checkCode&callback=JSON_CALLBACK"
    let api2 = "https://web.kwwblcj.com/api.php?m=weixin-send&callback=JSON_CALLBACK"
    request(
